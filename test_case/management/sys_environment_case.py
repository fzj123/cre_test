...
class SysEnvironmentCase(myunit.MyTest):
    ...
    def test_newbutton_promptbox(self):
        ...
        try:
            ...
            log().exception('Failing judgment, the result is'+ e)
   ...
   #选择一条或多条环境变量点击“导出”
    ...
    def test_import_button_sure(self):
        env = SysEnvironmentPage(self.driver)
        self.url = '/managecenter/system/environment'
        env.open(self.url)
        env.login_action('admin', 'admin')
        ...
        try:
            ...
            log().exception('Failing judgment, the result is'+ e)
        insert_img(self.driver, 'test_import_button_sure.jpg')

    #导入文件时查看，有“覆盖”和“不覆盖”两种
    def test_import_button_choose(self):
        env = SysEnvironmentPage(self.driver)
        self.url = '/managecenter/system/environment'
        env.open(self.url)
        env.login_action('admin', 'admin')
        ...
        try:
            ...
            log().exception('Failing judgment, the result is'+ e)
        insert_img(self.driver, 'test_import_button_choose.jpg')
    #导入文件后,可以在表单中查询到
    def test_import_buttot_save(self):
        env = SysEnvironmentPage(self.driver)
        self.url = '/managecenter/system/environment'
        env.open(self.url)
        env.login_action('admin', 'admin')
        ...
        try:
            ...
            log().exception('Failing judgment, the result is'+ e)
        insert_img(self.driver, 'test_import_buttot_save.jpg')
    #选择应用类型值后，点击“查询”，可查询出符合应用类型的变量结果
    def test_appname_query(self):
        env = SysEnvironmentPage(self.driver)
        self.url = '/managecenter/system/environment'
        env.open(self.url)
        env.login_action('admin', 'admin')
        ...
        try:
            ...
            log().exception('Failing judgment, the result is'+ e)
        insert_img(self.driver, 'test_appname_query.jpg')
    #在变量名框中输入名称，点击“查询”
    def test_variable_query(self):
        ...
        try:
            ...
            log().exception('Failing judgment, the result is'+ e)
        insert_img(self.driver, 'test_variable_query.jpg')
    #在描述框框中输入描述内容，点击“查询”
    def test_describe_query(self):
        ...
        try:
            ...
            log().exception('Failing judgment, the result is'+ e)
        insert_img(self.driver, 'test_describe_query.jpg')